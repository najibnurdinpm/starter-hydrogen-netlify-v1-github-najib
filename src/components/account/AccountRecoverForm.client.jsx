...
import { callAccountUpdateApi } from './AccountDetailsEdit.client';
            ...
            <div className="max-w-md w-full">
                {submitSuccess ? (
                    <>
                        ...
                        <p className="mt-4">
                            if that email address is in out system, you will receive an email
                ...
                <form noValidate className="pt-6 pb-8 mt-4 mb-4" onSubmit={onSubmit}>
                    {submitError && (
                        <div className="flex items-center justify-center mb-4 bg-zinc-500">
                    ...
                    <div className="mb-3">
                        ...
                        {!emailError ? (
                            ...
                            <p className={`text-red-500 text-ts`}>{emailError}</p>
                        )}
                    </div>
