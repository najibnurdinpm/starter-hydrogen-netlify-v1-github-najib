...
export function AccountCreateForm() {
    ...
    async function onSubmit(event) {
        ...
        const accountCreateResponse = await callAccountCreate({
            email,
            password,
        });
        ...
        <div className="flex justify-center my-24 px-4">
            <div className="max-w-md w-full">
                ...
                <form noValidate className="pt-6 pb-8 mt-4 mb-4" onSubmit={onSubmit}>
                    {submitError && (
                        <div className="flex item-center justify-center mb-6 bg-zinc-500">
                            <p className="m-4 text-4 text-contrast">{submitError}</p>
                        </div>
                    )}
                    <div className="mb-3">
                        <input
                    ...
                    <div className="flex item-center justify-between">
                        <button className="bg-gray-900 text-contrast rounded py-2 px-4 focus:shadow-outline block w-full"
                            type="submit"
                        >
                            Create Account
                        </button>
